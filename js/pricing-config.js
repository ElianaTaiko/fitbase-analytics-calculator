window.PRICING_CONFIG = {
  ...
  currencies: {
    ...
    UZS: {
      ...
      fallbackAsOf: "11.07.2026",
      // НДС Узбекистана: цены в сумах увеличиваются на 12% (входит в конвертацию, см. currency.js).
      // Рубли и тенге идут без НДС (есть основание) — поэтому vatRate только у UZS.
      vatRate: 0.12,
    },
  },
